      ...
      <div className="container">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-center">
            <div>
              <h2 className="font-serif text-2xl md:text-3xl">Давайте вместе создадим что-то потрясающее! </h2>
              <p className="text-sm md:text-base mt-2">
                Готовы воплотить в жизнь свой следующий проект? Давайте свяжемся и обсудим, как я могу помочь вам достичь ваших целей.
              </p>
            </div>
            <div>
              <button
                className="text-white bg-gray-900 inline-flex items-center
                px-6 h-12 rounded-xl gap-2 w-max"
              >
