    ...
    <section className="pb-16 lg:py-24">
      <div className="container">
        <div className="flex justify-center">
          <p className="uppercase font-semibold tracking-widest bg-gradient-to-r from-emerald-300 to-sky-400 text-center text-transparent bg-clip-text mb-6">Real-world Results</p>
        </div>
        <h2 className="font-serif text-3xl md:text-5xl text-center mb-4">Featured Projects</h2>
        <p className="text-center md:text-lg lg:text-xl text-white/60 mb-10 md:mb-20 max-w-md mx-auto">See how I transformed concepts into engaging digital experiences.</p>
        <div className="flex flex-col gap-20">
          {portfolioProjects.map((project) => (
            <div
              ...
              after:outline-white/20 px-8 pt-8 md:px-10 md:pt-12 lg:px-20 lg:pt-16 after:pointer-events-none"
              key={project.title}
            >
              <div
